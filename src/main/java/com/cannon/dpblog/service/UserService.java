...
import com.cannon.dpblog.dao.UserMapper;
import com.cannon.dpblog.entity.LoginTicket;
...
import com.cannon.dpblog.util.MailClient;
...
public class UserService implements CommunityConstant {
    ...
    public Map<String, Object> register(User user) {
        ...
        // http://localhost:8080/dpblog/activation/101/code
    ...
    public Map<String, Object> login(String username, String password, int expiredSeconds) {
        ...
        String logKey = RedisKeyUtil.getTicketKey(loginTicket.getTicket());
        redisTemplate.opsForValue().set(logKey,loginTicket);
